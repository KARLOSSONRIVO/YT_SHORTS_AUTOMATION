...
from app.services.pollinations_image_generation_service import PollinationsImageGenerationService
...
def get_pollinations_client() -> PollinationsClient:
    ...
    return PollinationsClient(
        ...
        timeout_seconds=settings.pollinations_image_timeout_seconds,
    )


@lru_cache
def get_pollinations_image_generation_service() -> PollinationsImageGenerationService:
    settings = get_settings()
    return PollinationsImageGenerationService(
        ...
        width=settings.pollinations_image_width,
        height=settings.pollinations_image_height,
    )
...
def get_tts_service() -> TTSService:
    ...
    return TTSService(
        ...
        fallback_model=settings.pollinations_tts_model,
        allow_placeholder_generation=settings.allow_placeholder_generation,
    )
...
def get_image_service() -> ImageService:
    ...
    return ImageService(
        ffmpeg_client=get_ffmpeg_client(),
        output_dir=settings.output_dir,
        image_generation_service=get_pollinations_image_generation_service(),
        allow_placeholder_generation=settings.allow_placeholder_generation,
    )
